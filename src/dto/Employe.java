...
public class Employe extends Personne {
    ...
    private List<EmployeAgency> employeAgencyList;
    ...
    public List<EmployeAgency> getEmployeAgencyList() {
        return employeAgencyList;
    }

    public void setEmployeAgencyList(List<EmployeAgency> employeAgencyList) {
        this.employeAgencyList = employeAgencyList;
    }
